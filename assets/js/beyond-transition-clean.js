...
(function () {
  ...
  function playLeave() {
    ...
    active
      ...
      .to(stage, { scale: 0, duration: 0.92, ease: 'power3.in' }, 0.12)
      .to(core, { scale: 0, duration: 0.92, ease: 'power3.in' }, 0.12)
      ...
      .to(stage, { autoAlpha: 0, duration: 0.12, ease: 'none' }, 1.02)
      .set(voidEl, { autoAlpha: 1 }, 1.04)
      .to({}, { duration: VOID_HOLD });
  }
